...
class Rossmann( object ):
    def __init__( self ): 
        ...
        self.promo_time_week_mms           = pickle.load(open(self.home_path + 'parameter/promo_time_week_mms.pkl', 'rb'))
        self.year_mms                      = pickle.load(open(self.home_path + 'parameter/year_mms.pkl', 'rb'))
        self.store_type_enconding          = pickle.load(open(self.home_path + 'parameter/store_type_enconding.pkl', 'rb'))
    ...
    def data_preparation(self, df5):
        ...
        # promo time week
        df5['promo_time_week'] = self.promo_time_week_mms.transform( df5[['promo_time_week']].values)

        # year
        df5['year'] = self.year_mms.transform( df5[['year']].values)
        ...
        df5['store_type'] = self.store_type_enconding.transform(df5['store_type'])
